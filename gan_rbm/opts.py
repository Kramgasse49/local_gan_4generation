...
def model_opts(parser):
    ...
    group.add_argument('-dec_padding_idx', type=int, default=0,
                       help='Number of words in embedding of the encoder')
    group.add_argument('-dec_max_len', type=int, default=15,
    ...
    # for gan ael 
    group.add_argument('-gan_loss_type', type=str, default='Log',
                       choices=['Wassertien', 'LOG', 'Sqrt'],
                       help="gan_loss_type of the discriminator in GAN")
    group.add_argument('-d_train_ratio', type=int, default=5,
                       help="d_train_ratio of GAN")

    # for gan ael 
    group.add_argument('-rbm_path', type=str, default='Log',
                       help="dbm model path ")
    group.add_argument('-rbm_rq_prefix', type=str,
                       help="")
    group.add_argument('-rbm_qr_prefix', type=str,
                       help="")
    group.add_argument('-query_norm_path', type=str,
                       help="")
    group.add_argument('-reply_norm_path', type=str,
                       help="")
...
def train_opts(parser):
    ...
    group.add_argument('-d_lr', type=float, default=0.0001,
                       help="""Starting learning rate.
                       Recommended settings: sgd = 1, adagrad = 0.1,
                       adadelta = 1, adam = 0.001""")
    group.add_argument('-dec_lr', type=float, default=0.0001,
                       help="""Starting learning rate.
                       Recommended settings: sgd = 1, adagrad = 0.1,
                       adadelta = 1, adam = 0.001""")
    group.add_argument('-s2s_lr', type=float, default=0.0001,
                       help="""Starting learning rate.
                       Recommended settings: sgd = 1, adagrad = 0.1,
                       adadelta = 1, adam = 0.001""")
...
def test_opts(parser):
    ...
    group.add_argument('-beam_type', type=str, choices=['general', 'greedy'],
                       help="Beam Method")
